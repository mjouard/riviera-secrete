...
- [Frontend Next.js](frontend_nextjs.md) — Next.js 16 App Router, pages (dont /connexion, /confirmer-email), NextAuth Google+Credentials, homepage (carte/activités/filtres), Vercel, design
- [Architecture & roadmap](architecture_future.md) — décisions stack, état P1-P4.5 (tout fait), URLs Railway/Vercel
